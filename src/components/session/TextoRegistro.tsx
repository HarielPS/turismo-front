...
const TextoRegistro: React.FC<Props> =({ onRegisterClick }) => {
  return (
    <>
    ...
    <div className='hidden md:block '>
        ...
        <div className=' flex flex-col items-center justify-center w-3/4 min-h-[50vh] rounded-xl p-12 space-y-8 text-center'>
            ...
            <button onClick={onRegisterClick} className="px-8 py-3 bg-text text-background rounded-lg font-bold hover:bg-gray-100 transition-transform hover:scale-105 shadow-lg">
                Iniciar sesión
            </button>
        </div>
        </div>
    ...
    <div className='block md:hidden h-1/2' >
        ...
        <div className='flex flex-col items-center h-4/5 min-h-[50vh] rounded-xl sm:p-12 space-y-8 text-center'>
            ...
            <button onClick={onRegisterClick} className="px-8 py-3 bg-white text-blue-600 rounded-lg font-bold hover:bg-gray-100 transition-transform hover:scale-105 shadow-lg">
                Iniciar sesión
            </button>
        </div>
        </div>
