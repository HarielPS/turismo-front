...
{/* inicio sesion pc */}
    <div className="max-w-md mx-auto p-8 rounded-lg ">
      ...
      <div className="flex gap-2 mb-4">
        <button className="w-full flex items-center justify-center gap-2 bg-detail py-2 px-4 rounded hover:bg-gray-700">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input
          ...
          className="w-full p-2 rounded bg-detail border border-gray-700 text-text mb-4"
          required
        />
