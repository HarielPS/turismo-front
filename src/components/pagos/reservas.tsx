    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
        {Object.entries(reservasPorRuta).map(([ruta, reservas]) => (
          <div key={ruta} className="border p-4 rounded-xl shadow-md bg-white">
            ...
            {reservas.map((reserva) => {
              ...
              return (
                <div
                  key={reserva.id}
                  className="w-full border border-gray-300 rounded-lg shadow-sm mb-3 p-3 cursor-pointer hover:bg-gray-50 transition"
