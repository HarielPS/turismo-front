        ...
        <div className="flex flex-col items-center w-full max-w-2xl relative">
            <div className="flex items-center w-full rounded-t-xl">
                <div className="flex items-center bg-white w-full p-4 rounded-lg ">
                    {/* icono del search */}
                    <div className="mr-4 text-black border-r border-gray-500 pr-4">
                ...
                <button className="bg-blue-500 text-white font-bold px-4 py-4 rounded-xl ml-2 hover:bg-blue-600 transition-colors cursor-pointer">
                    Buscar
                </button>
            </div>
