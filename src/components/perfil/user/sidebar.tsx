                ...
                {!open && (
                  <div className="absolute left-full top-1/2 -translate-y-1/2 ml-2 hidden group-hover:block">
                    <div className="relative">
                      <div className="bg-detail text-text text-sm px-3 py-2 rounded-md whitespace-nowrap">
                        {item.name}
                        <div className="absolute right-full top-1/2 -translate-y-1/2 w-2 h-2 bg-accent transform rotate-45"></div>
                      </div>
                    </div>
                  </div>
                )}
